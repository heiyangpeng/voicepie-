...
需<big><font style="color: red">先插入领夹麦设备接收端</font></big>才可打开应用驱动包进行安装
...
<strong>
<small>1. 电脑先插入<big><code>AI翻译棒（简称接收端）</code></big>，同时领夹麦设备开机，蓝色灯光闪烁直至常亮则成功连接<big><code>接收端</code></big><br></small>
