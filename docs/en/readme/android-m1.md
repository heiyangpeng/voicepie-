# Using Translation Microphone on Android

::: tip 💡 This guide provides detailed steps for beginners or users unfamiliar with mobile app installation.

✓ Contact customer service to customize voice settings - ensure real audience hears natural voice instead of AI during livestreaming 🎤 🎵
:::
...
<strong>
<small>1. Open Voicepie APP, accept any permission requests that appear.<br></small>
<small>2. Insert AI Translation Stick [Receiver] into phone, wear earphones. When the blue light stays steady, connection is successful.<br></small>
<small>3. Grant overlay permissions when prompted, enter main interface to start using translation features.<br></small>
