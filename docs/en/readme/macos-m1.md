# Using TransMic on macOS

::: tip 💡 This guide provides step-by-step instructions for users unfamiliar with the Voicepie application to get started easily.

❗️Only compatible with macOS devices powered by an M-series chip!
...
1. Install voicepie App on macOS

Download and install the app from the App Store or official website.

![](https://bu.dusays.com/2024/12/07/6753f6be9ea0a.jpg)

2. Connect AI Translator and Clip-On Microphone

Plug in the AI Translator dongle into your MacBook and power on the clip-on microphone device.
When the blue LED on the clip-on microphone flashes and turns steady, it is successfully paired with the AI Translator.

![](https://bu.dusays.com/2024/12/07/6753f6bd7d9dd.png)

3. Launch and Configure the App

Open the voicepie app. Once the AI Translator is recognized, you will enter the main interface.
Grant permissions if prompted by the system.

![](https://bu.dusays.com/2024/12/07/6753f6bd85037.png)

4. Set Audio Input and Output

Ensure the macOS audio input and output are set to kikago.ai enc headphone in the system sound settings.
...
Begin using the real-time translation feature for seamless communication.
