...
Download and install the app from the App Store or the official website.

![](https://bu.dusays.com/2024/12/07/6753f6be9ea0a.jpg)

2. Connect AI Translator and Earphones

Plug in the AI Translator dongle into your MacBook. Power on and wear the Bluetooth earphones, which will automatically connect to the AI Translator.
No need to pair the earphones directly with your Mac.

![](https://bu.dusays.com/2024/12/07/6753f6bd7d9dd.png)

3. Launch and Configure the App

Open the voicepie app. Once the AI Translator is recognized, the main interface will load.
