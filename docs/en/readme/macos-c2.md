# Using TransBuds C2 on macOS(iOS version)
...
2. Open the app and connect your TransBuds C2. Wait for the activation process to complete.

![](https://bu.dusays.com/2024/12/07/6753f6bd7d9dd.png)

3. Once the earphones are successfully recognized, you will enter the main app interface.
